...
class BoundingSphere {
     ...
     */
    constructor(center: Vec3 = new Vec3(), radius: number = 0.5) {
        Logger.Assert(!Object.isFrozen(center), `The constructor of 'BoundingSphere' does not accept a constant (frozen) object as a 'center' parameter`);
