...
// Engine.prototype.restoreSingleAttachment = function(): void {
//     const gl = this._gl;

//     this.bindAttachments([gl.BACK]);
// };

// Engine.prototype.buildTextureLayout = function(textureStatus: boolean[]): number[] {
//     const gl = this._gl;
...
// Engine.prototype.bindAttachments = function(attachments: number[]): void {
//     const gl = this._gl;
...
//             attachments[i] = (<any>gl)[this._webGLVersion > 1 ? "COLOR_ATTACHMENT" + i : "COLOR_ATTACHMENT" + i + "_WEBGL"];
...
//             this.engineTexture._bindTextureDirectly(gl.TEXTURE_2D, texture, true);
//             gl.generateMipmap(gl.TEXTURE_2D);
//             this.engineTexture._bindTextureDirectly(gl.TEXTURE_2D, null);
//         }
//     }
...
//         var attachment = (<any>gl)[this._webGLVersion > 1 ? "COLOR_ATTACHMENT" + i : "COLOR_ATTACHMENT" + i + "_WEBGL"];
...
//         gl.texImage2D(gl.TEXTURE_2D, 0, this.engineTexture._getRGBABufferInternalSizedFormat(type), width, height, 0, gl.RGBA, this.engineTexture._getWebGLTextureType(type), null);
...
//             gl.TEXTURE_2D,
//             0,
//             this._webGLVersion < 2 ? gl.DEPTH_COMPONENT : gl.DEPTH_COMPONENT16,
//             width,
//             height,
//             0,
//             gl.DEPTH_COMPONENT,
...
//         this.engineTexture._internalTexturesCache.push(depthTexture);
//     }
...
//     if (this._webGLVersion < 2 || !textures) {
//         return 1;
//     }
