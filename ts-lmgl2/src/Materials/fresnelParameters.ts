...
export class FresnelParameters {
  ...
  public set isEnabled(value: boolean) {
    ...
    //   Constants.MATERIAL_FresnelDirtyFlag | Constants.MATERIAL_MiscDirtyFlag
    // );
  }
   ...
   */
  public equals(
    otherFresnelParameters: DeepImmutable<FresnelParameters>
  ): boolean {
    return (
   ...
   */
  public static Parse(
    parsedFresnelParameters: IFresnelParametersSerialized
  ): FresnelParameters {
