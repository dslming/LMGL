...
export class MaterialHelper {
   ...
   */
  public static BindSceneUniformBuffer(
    effect: Effect,
  ...
  public static PrepareDefinesForFrameBoundValues(
    ...
    // useClipPlane2 =
    //   useClipPlane == null
    //     ? scene.clipPlane2 !== undefined && scene.clipPlane2 !== null
    //     : useClipPlane;
    // useClipPlane3 =
    //   useClipPlane == null
    //     ? scene.clipPlane3 !== undefined && scene.clipPlane3 !== null
    //     : useClipPlane;
    // useClipPlane4 =
    //   useClipPlane == null
    //     ? scene.clipPlane4 !== undefined && scene.clipPlane4 !== null
    //     : useClipPlane;
    // useClipPlane5 =
    //   useClipPlane == null
    //     ? scene.clipPlane5 !== undefined && scene.clipPlane5 !== null
    //     : useClipPlane;
    // useClipPlane6 =
    //   useClipPlane == null
    //     ? scene.clipPlane6 !== undefined && scene.clipPlane6 !== null
    //     : useClipPlane;
  ...
  public static PrepareDefinesForAttributes(
    ...
    //   defines["UV" + i] = defines._needUVs
    //     ? mesh.isVerticesDataPresent(`uv${i === 1 ? "" : i}`)
    //     : false;
    // }
   ...
   */
  public static PrepareDefinesForOIT(
    scene: Scene,
    defines: any,
    ...
    //   scene.useOrderIndependentTransparency && needAlphaBlending;
    // defines.ORDER_INDEPENDENT_TRANSPARENCY_16BITS = !scene.getEngine().getCaps()
    //   .textureFloatLinearFiltering;

    if (
      previousDefine !== defines.ORDER_INDEPENDENT_TRANSPARENCY ||
      previousDefine16Bits !== defines.ORDER_INDEPENDENT_TRANSPARENCY_16BITS
    ) {
      defines.markAsUnprocessed();
    }
  }
   ...
   */
  public static PrepareDefinesForPrePass(
    scene: Scene,
    defines: any,
  ...
  public static PrepareUniformsAndSamplersList(
    ...
    for (var lightIndex = 0; lightIndex < maxSimultaneousLights; lightIndex++) {
      ...
      this.PrepareUniformsAndSamplersForLight(
        lightIndex,
        uniformsList,
        samplersList,
   ...
   * @param defines The current Defines of the effect
   */
  public static PrepareAttributesForBakedVertexAnimation(
    attribs: string[],
    mesh: AbstractMesh,
    defines: any
  ): void {
    const enabled =
      defines["BAKED_VERTEX_ANIMATION_TEXTURE"] && defines["INSTANCES"];
   ...
   */
  public static PushAttributesForInstances(
    attribs: string[],
    needsPreviousMatrices: boolean = false
  ): void {
    attribs.push("world0");
    attribs.push("world1");
    attribs.push("world2");
  ...
  public static BindLights(
    ...
    for (var i = 0; i < len; i++) {
      ...
      this.BindLight(
        ...
        scene,
        effect,
        typeof defines === "boolean" ? defines : defines["SPECULARTERM"],
        mesh.receiveShadows
      );
    }
  }
