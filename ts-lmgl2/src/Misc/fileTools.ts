...
export class FileTools {
    ...
    public static LoadImage(
        ...
        mimeType: string = ""): Nullable<HTMLImageElement> {
        let url: string;
        ...
        if (typeof Image === "undefined") {
            ...
            }, undefined, true, (request, exception) => {
                // if (onError) {
     ...
     * @returns a file request object
     */
    public static LoadFile(url: string, onSuccess: (data: string | ArrayBuffer, responseURL?: string) => void, onProgress?: (ev: ProgressEvent) => void, useArrayBuffer?: boolean, onError?: (request?: WebRequest, exception?: LoadFileError) => void): IFileRequest {
        ...
        }, onProgress, useArrayBuffer, onError ? (error) => {
     ...
     * @returns a file request object
     */
    public static RequestFile(url: string, onSuccess: (data: string | ArrayBuffer, request?: WebRequest) => void, onProgress?: (event: ProgressEvent) => void, useArrayBuffer?: boolean, onError?: (error: RequestFileError) => void, onOpened?: (request: WebRequest) => void): IFileRequest {
...
EngineFile._FileToolsLoadImage = FileTools.LoadImage.bind(FileTools);
EngineFile._FileToolsLoadFile = FileTools.LoadFile.bind(FileTools);
