...
import { ISceneSerializableComponent, SceneComponentConstants } from "../Scene/sceneComponent";
...
SubSurfaceConfiguration._SceneComponentInitialization = (scene: Scene) => {
    ...
    let component = scene.sceneComponent._getComponent(SceneComponentConstants.NAME_SUBSURFACE) as SubSurfaceSceneComponent;
    if (!component) {
