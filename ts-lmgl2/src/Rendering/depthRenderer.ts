...
export class DepthRenderer {
    ...
    constructor(scene: Scene, type: number = Constants.TEXTURETYPE_FLOAT, camera: Nullable<Camera> = null, storeNonLinearDepth = false) {
        ...
        // Render target
        var format = (this.isPacked || engine._webGLVersion === 1) ? Constants.TEXTUREFORMAT_RGBA : Constants.TEXTUREFORMAT_R;
        ...
        this._depthMap.onClearObservable.add((engine) => {
            engine.engineDraw.clear(this._clearColor, true, true, true);
        });
        ...
        var renderSubMesh = (subMesh: SubMesh): void => {
            ...
            engine.engineState.setState(material.backFaceCulling, 0, false, scene.useRightHandedSystem);
            ...
            var camera = this._camera || scene.sceneRender.activeCamera;
