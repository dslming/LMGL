    ...
    */
    ...
    private _createBlurPostProcess(ssaoRatio: number, blurRatio: number): void {
        ...
        this._blurHPostProcess.onApply = (effect: Effect) => {
            ...
            effect.setFloat("near", this._scene.sceneRender.activeCamera.minZ);
            effect.setFloat("far", this._scene.sceneRender.activeCamera.maxZ);
    ...
    private _createSSAOPostProcess(ratio: number): void {
        ...
        this._ssaoPostProcess.onApply = (effect: Effect) => {
            ...
            effect.setFloat("near", this._scene.sceneRender.activeCamera.minZ);
            effect.setFloat("far", this._scene.sceneRender.activeCamera.maxZ);
            effect.setFloat("xViewport", Math.tan(this._scene.sceneRender.activeCamera.fov / 2) * this._scene.getEngine().getAspectRatio(this._scene.sceneRender.activeCamera, true));
            effect.setFloat("yViewport", Math.tan(this._scene.sceneRender.activeCamera.fov / 2));
            effect.setMatrix("projection", this._scene.sceneMatrix.getProjectionMatrix());
    ...
    private _createSSAOCombinePostProcess(ratio: number): void {
        ...
        this._ssaoCombinePostProcess.onApply = (effect: Effect) => {
            let viewport = this._scene.sceneRender.activeCamera!.viewport;
