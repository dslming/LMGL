    ...
    */
    ...
    private _createChromaticAberrationPostProcess(ratio: number): void {
        ...
        this._chromaticAberrationPostProcess.onApply = (effect: Effect) => {
            ...
            effect.setFloat('screen_width', this._scene.getEngine().engineFramebuffer.getRenderWidth());
            effect.setFloat('screen_height', this._scene.getEngine().engineFramebuffer.getRenderHeight());
