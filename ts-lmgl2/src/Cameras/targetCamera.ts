...
export class TargetCamera extends Camera {
  ...
  public _checkInputs(): void {
    var directionMultiplier = this.invertRotation
      ? -this.inverseRotationSpeed
      : 1.0;
      ...
      case Camera.RIG_MODE_STEREOSCOPIC_INTERLACED:
        ...
        var rightSign =
          ...
          Camera.RIG_MODE_STEREOSCOPIC_SIDEBYSIDE_CROSSEYED
            ? -1
            : 1;
        this._getRigCamPositionAndTarget(
  ...
  private _getRigCamPositionAndTarget(
    halfSpace: number,
    rigCamera: TargetCamera
  ) {
    var target = this.getTarget();
    target.subtractToRef(this.position, TargetCamera._TargetFocalPoint);

    TargetCamera._TargetFocalPoint
      .normalize()
      .scaleInPlace(this._initialFocalDistance);
    var newFocalTarget = TargetCamera._TargetFocalPoint.addInPlace(
      this.position
    );
    ...
    TargetCamera._TargetTransformMatrix.multiplyToRef(
      Matrix.RotationAxis(rigCamera.upVector, halfSpace),
