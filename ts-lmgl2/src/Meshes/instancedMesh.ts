...
export class InstancedMesh extends AbstractMesh {
  ...
  public _postActivate(): void {
    // if (this._sourceMesh.edgesShareWithInstances && this._sourceMesh._renderingGroup) {
...
// Mesh.prototype._processInstancedBuffers = function (
...
//       );
//     } else {
//       this._userInstancedBuffersStorage.vertexBuffers[kind]!.updateDirectly(
//         data,
//         0
//       );
//     }
