...
export class AbstractMesh extends TransformNode implements IDisposable, ICullable {
   ...
   */
  public static readonly CULLINGSTRATEGY_OPTIMISTIC_INCLUSION_THEN_BSPHERE_ONLY =
  ...
  //     this.name +
  //     ", isInstance: " +
  //     (this.getClassName() !== "InstancedMesh" ? "YES" : "NO");
  ...
  //     ret +=
  //       ", freeze wrld mat: " +
  //       (this._isWorldMatrixFrozen || this._waitingData.freezeWorldMatrix
  //         ? "YES"
  //         : "NO");
  //   }
  //   return ret;
  ...
  /** @hidden */
  // public _getActionManagerForTrigger(
  //   trigger?: number,
  //   initialCall = true
  // ): Nullable<AbstractActionManager> {
   ...
   * @returns the current mesh
   */
  // public normalizeToUnitCube(
  //   includeDescendants = true,
  //   ignoreRotation = false,
  //   predicate?: Nullable<(node: AbstractMesh) => boolean>
  // ): AbstractMesh {
  //   return <AbstractMesh>(
  //     super.normalizeToUnitCube(includeDescendants, ignoreRotation, predicate)
  //   );
  // }
  /**
  ...
  //     this._meshCollisionData._oldPositionForCollisions
  //   );
  ...
  //     this._meshCollisionData._oldPositionForCollisions,
  //     displacement,
  //     this._meshCollisionData._collider,
  //     3,
  //     this,
  ...
  //     this._meshCollisionData._oldPositionForCollisions,
  //     this._meshCollisionData._diffPositionForCollisions
  //   );

  //   if (
  //     this._meshCollisionData._diffPositionForCollisions.length() >
  ...
  //     pickingInfo.distance = skipBoundingInfo
  //       ? 0
  //       : Vector3.Distance(ray.origin, boundingInfo.boundingSphere.center);
  ...
  //     pickingInfo.distance = Vector3.Distance(
  //       ray.origin,
  ...
  //     pickingInfo.faceId =
  //       intersectInfo.faceId +
  //       subMeshes.data[intersectInfo.subMeshId].indexStart /
  //         (this.getClassName().indexOf("LinesMesh") !== -1 ? 2 : 3);
