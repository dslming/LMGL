...
export class Layer {
    ...
    */
    ...
    constructor(
        ...
        let layerComponent = this._scene.sceneComponent._getComponent(SceneComponentConstants.NAME_LAYER) as LayerSceneComponent;
        if (!layerComponent) {
            layerComponent = new LayerSceneComponent(this._scene);
            this._scene.sceneComponent._addComponent(layerComponent);
        }
    ...
    private _createIndexBuffer(): void {
        ...
        this._indexBuffer = engine.engineVertex.createIndexBuffer(indices);
    }
    ...
    public render(): void {
        ...
        // Draw order
        if (!this.alphaTest) {
            engine.engineAlpha.setAlphaMode(this.alphaBlendingMode);
