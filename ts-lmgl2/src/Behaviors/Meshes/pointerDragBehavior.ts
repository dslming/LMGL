...
export class PointerDragBehavior implements Behavior<AbstractMesh> {
  ...
  public attach(
    ...
    //   this._scene.sceneEventTrigger.onPointerObservable.add(
    ...
    //         ) {
    //           this._startDrag(
    //             (<PointerEvent>pointerInfo.event).pointerId,
    //             pointerInfo.pickInfo.ray,
    //             pointerInfo.pickInfo.pickedPoint
    //           );
    //         }
    ...
    //         if (
    //           this.currentDraggingPointerID ===
    //             PointerDragBehavior._AnyMouseID &&
    ...
    //               this._lastPointerRay[pointerId] =
    //                 this._lastPointerRay[this.currentDraggingPointerID];
    ...
    //           this._lastPointerRay[pointerId] = new Ray(
    //             new Vector3(),
    //             new Vector3()
    //           );
    //         }
    //         if (pointerInfo.pickInfo && pointerInfo.pickInfo.ray) {
    //           this._lastPointerRay[pointerId].origin.copyFrom(
    //             pointerInfo.pickInfo.ray.origin
    //           );
    //           this._lastPointerRay[pointerId].direction.copyFrom(
    ...
    this._beforeRenderObserver =
      this._scene.sceneEventTrigger.onBeforeRenderObservable.add(() => {
        if (this._moving && this.moveAttached) {
          PivotTools._RemoveAndStorePivotPoint(this.attachedNode);
          // Slowly move mesh to avoid jitter
          this._targetPosition.subtractToRef(
          ...
          this.attachedNode
            .getAbsolutePosition()
            .addToRef(this._tmpVector, this._tmpVector);
   ...
   */
  // public startDrag(
  //   pointerId: number = PointerDragBehavior._AnyMouseID,
  //   fromRay?: Ray,
  ...
  //   this._updateDragPlanePosition(
  //     this._startDragRay,
  //     startPickedPoint ? startPickedPoint : this._tmpVector
  //   );
  ...
  //             this.attachedNode.getWorldMatrix().getRotationMatrix(),
  //             this._worldDragAxis
  //           )
  ...
  //       this.attachedNode.absolutePosition.subtractToRef(
  //         ray.origin,
  //         this._alternatePickedPoint
  //       );
  //       this._alternatePickedPoint.normalize();
  //       this._alternatePickedPoint.scaleInPlace(
  //         this._useAlternatePickedPointAboveMaxDragAngleDragSpeed *
  //           Vector3.Dot(this._alternatePickedPoint, this._tmpVector)
  //       );
  ...
  //       this._alternatePickedPoint.addInPlace(
  //         this.attachedNode.absolutePosition
  //       );
  ...
  //   // var pickResult = PointerDragBehavior._planeScene.scenePick.pickWithRay(
  //   //   ray,
  //   //   (m) => {
  ...
  public detach(): void {
    ...
    //   this._scene.sceneEventTrigger.onPointerObservable.remove(
    //     this._pointerObserver
    //   );
    // }
    // if (this._beforeRenderObserver) {
    //   this._scene.sceneEventTrigger.onBeforeRenderObservable.remove(
    //     this._beforeRenderObserver
    //   );
    // }
    this.releaseDrag();
