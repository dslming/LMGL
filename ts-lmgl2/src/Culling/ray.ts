...
//    */
//   public intersectsBoxMinMax(
//     minimum: DeepImmutable<Vector3>,
//     maximum: DeepImmutable<Vector3>,
//     intersectionTreshold: number = 0
//   ): boolean {
//     const newMinimum = Ray._TmpVector3[0].copyFromFloats(
//       minimum.x - intersectionTreshold,
//       minimum.y - intersectionTreshold,
//       minimum.z - intersectionTreshold
//     );
//     const newMaximum = Ray._TmpVector3[1].copyFromFloats(
//       maximum.x + intersectionTreshold,
...
//     intersectionTreshold: number = 0
//   ): boolean {
//     return this.intersectsBoxMinMax(
//       box.minimum,
//       box.maximum,
...
//     pickingInfoA: DeepImmutable<PickingInfo>,
//     pickingInfoB: DeepImmutable<PickingInfo>
//   ): number {
...
//     var isIntersected =
//       tc > 0 && tc <= this.length && dP.lengthSquared() < threshold * threshold; // return intersection result
...
//     origin: Vector3,
//     end: Vector3,
//     world: DeepImmutable<Matrix> = Matrix.IdentityReadOnly
//   ): Ray {
...
//     var farScreenSource = TmpVectors.Vector3[1].copyFromFloats(
//       nearScreenSource.x,
//       nearScreenSource.y,
//       1.0
//     );
...
//  */
// export type TrianglePickingPredicate = (
//   p0: Vector3,
//   p1: Vector3,
//   p2: Vector3,
//   ray: Ray
...
// ScenePick.prototype.createPickingRay = function (
//   x: number,
//   y: number,
//   world: Matrix,
...
// ScenePick.prototype.createPickingRayToRef = function (
//   x: number,
//   y: number,
//   world: Matrix,
//   result: Ray,
...
//   y =
//     y / engine.getHardwareScalingLevel() -
//     (engine.engineFramebuffer.getRenderHeight() - viewport.y - viewport.height);
...
// ScenePick.prototype.createPickingRayInCameraSpace = function (
//   x: number,
//   y: number,
//   camera?: Camera
// ): Ray {
...
// ScenePick.prototype.createPickingRayInCameraSpaceToRef = function (
//   x: number,
//   y: number,
//   result: Ray,
//   camera?: Camera
...
// ScenePick.prototype._internalPickForMesh = function (
//   pickingInfo: Nullable<PickingInfo>,
//   rayFunction: (world: Matrix) => Ray,
//   mesh: AbstractMesh,
//   world: Matrix,
...
// ScenePick.prototype._internalPick = function (
//   rayFunction: (world: Matrix) => Ray,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   fastCheck?: boolean,
//   onlyBoundingInfo?: boolean,
...
//     {
//       let result = this._internalPickForMesh(
//         pickingInfo,
//         rayFunction,
//         mesh,
//         world,
...
// ScenePick.prototype._internalMultiPick = function (
//   rayFunction: (world: Matrix) => Ray,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   trianglePredicate?: TrianglePickingPredicate
// ): Nullable<PickingInfo[]> {
...
// ScenePick.prototype.pickWithBoundingInfo = function (
//   x: number,
//   y: number,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   fastCheck?: boolean,
...
// ScenePick.prototype.pick = function (
//   x: number,
//   y: number,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   fastCheck?: boolean,
...
// ScenePick.prototype.pickWithRay = function (
//   ray: Ray,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   fastCheck?: boolean,
//   trianglePredicate?: TrianglePickingPredicate
...
// ScenePick.prototype.multiPick = function (
//   x: number,
//   y: number,
//   predicate?: (mesh: AbstractMesh) => boolean,
//   camera?: Camera,
...
// ScenePick.prototype.multiPickWithRay = function (
//   ray: Ray,
//   predicate: (mesh: AbstractMesh) => boolean,
//   trianglePredicate?: TrianglePickingPredicate
// ): Nullable<PickingInfo[]> {
...
// Camera.prototype.getForwardRay = function (
//   length = 100,
//   transform?: Matrix,
//   origin?: Vector3
// ): Ray {
//   return this.getForwardRayToRef(
//     new Ray(Vector3.Zero(), Vector3.Zero(), length),
//     length,
//     transform,
//     origin
//   );
...
// Camera.prototype.getForwardRayToRef = function (
//   refRay: Ray,
//   length = 100,
//   transform?: Matrix,
//   origin?: Vector3
