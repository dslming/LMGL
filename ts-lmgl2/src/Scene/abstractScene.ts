 ...
 */
export type IndividualBabylonFileParser = (
  parsedData: any,
  scene: Scene,
  rootUrl: string
) => any;
...
export abstract class AbstractScene {
  ...
  private static _IndividualBabylonFileParsers: {
    [key: string]: IndividualBabylonFileParser;
  } = {};
   ...
   * @param parser Defines the parser to add
   */
  public static AddIndividualParser(
    name: string,
   ...
   * @returns the requested parser or null
   */
  public static GetIndividualParser(
    name: string
  ): Nullable<IndividualBabylonFileParser> {
  ...
  public static Parse(
    ...
    for (let parserName in this._BabylonFileParsers) {
      if (this._BabylonFileParsers.hasOwnProperty(parserName)) {
        this._BabylonFileParsers[parserName](
          jsonData,
          scene,
          container,
          rootUrl
