...
if (!gl || !ext || !extFloat || !extDepth || !extDeriv) {
  ...
  const draw = () => {
    ...
    gl.uniform1i(infoFinal.showPosition, usePosition.checked);
    gl.uniform1i(infoFinal.showNormal, useNormal.checked);
    gl.uniform1i(infoFinal.showDiffuse, useDiffuse.checked);
    gl.uniform1i(infoFinal.showDepth, useDepth.checked);
    gl.uniform1i(infoFinal.showAO, useAO.checked);
    gl.uniform1i(infoFinal.showBlurredAO, useBlurredAO.checked);
