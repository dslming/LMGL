...
// import "../Engine/engine.uniformBuffer";
...
export class UniformBuffer {
   ...
   */
  constructor(engine: WebGLEngine, data?: number[], dynamic?: boolean) {
    this._engine = engine;
   ...
   */
  public getBuffer(): Nullable<WebGLDataBuffer> {
    return this._buffer;
  }
  ...
  public _rebuild(): void {
    ...
    if (this._dynamic) {
      this._buffer = this._engine.engineUniform.createDynamicUniformBuffer(this._bufferData);
    } else {
      this._buffer = this._engine.engineUniform.createUniformBuffer(this._bufferData);
    }
  }
