...
//    */
   ...
   */
  public static GetPointerPrefix(engine: WebGLEngine): string {
...
//    */
  ...
  //     return FileTools.LoadImage(input, onLoad, onError, mimeType);
  //   }
  ...
  //   ): IFileRequest {
  //     return FileTools.LoadFile(url, onSuccess, onProgress, useArrayBuffer, onError);
  //   }
...
//    */
   ...
   */
  //   public static CreateScreenshotAsync(
  //     engine: Engine,
  //     camera: Camera,
  //     size: IScreenshotSize | number,
  //     mimeType: string = "image/png"
...
export function applyMixins(derivedConstructor: any, baseConstructors: any[]) {
  baseConstructors.forEach((baseConstructor) => {
    Object.getOwnPropertyNames(baseConstructor.prototype).forEach((name) => {
      Object.defineProperty(derivedConstructor.prototype, name, (Object as any).getOwnPropertyDescriptor(baseConstructor.prototype, name));
    });
  });
}
