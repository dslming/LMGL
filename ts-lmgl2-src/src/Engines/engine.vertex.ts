import { BufferPointer } from "../Buffer/bufferPointer";
...
export class EngineVertex {
  ...
  public _cachedIndexBuffer: Nullable<WebGLDataBuffer>;
  ...
  private _currentInstanceBuffers = new Array<WebGLDataBuffer>();
  ...
  public recordVertexArrayObject(
    ...
    indexBuffer: Nullable<WebGLDataBuffer>,
    effect: Effect
  ...
  /** @hidden */
  public _bindIndexBufferWithCache(indexBuffer: Nullable<WebGLDataBuffer>): void {
    if (indexBuffer == null) {
      return;
    }
   ...
   */
  public bindBuffers(vertexBuffers: { [key: string]: Nullable<VertexBuffer> }, indexBuffer: Nullable<WebGLDataBuffer>, effect: Effect): void {
   ...
   */
  public createIndexBuffer(indices: IndicesArray, updatable?: boolean): WebGLDataBuffer {
  ...
  private _createVertexBuffer(data: DataArray, usage: number): WebGLDataBuffer {
    var vbo = this._gl.createBuffer();
   ...
   */
  public createVertexBuffer(data: DataArray): WebGLDataBuffer {
    return this._createVertexBuffer(data, this._gl.STATIC_DRAW);
  }

  public bindIndexBuffer(buffer: Nullable<WebGLDataBuffer>): void {
    if (!this._vaoRecordInProgress) {
      this._unbindVertexArrayObject();
    }
