...
ThinEngine.prototype.updateVideoTexture = function(texture: Nullable<InternalTexture>, video: HTMLVideoElement, invertY: boolean): void {
    ...
    try {
        ...
        if (!this._videoTextureSupported) {
            ...
            (texture._workingContext! as any).clearRect(0, 0, texture.width, texture.height);
            (texture._workingContext! as any).drawImage(video, 0, 0, video.videoWidth, video.videoHeight, 0, 0, texture.width, texture.height);
