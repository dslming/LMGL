...
import { iGeometryInfo } from "./geometry";
...
export function boxBuilder(opts?: any): iGeometryInfo {
...
export function sphereBuilder(opts: any): iGeometryInfo {
  // Check the supplied options and provide defaults for unspecified ones
...
export function planeBuilder(opts?: any): iGeometryInfo {
    // Check the supplied options and provide defaults for unspecified ones
