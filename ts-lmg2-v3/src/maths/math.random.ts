...
const random = {
     ...
     * @ignore
     */
    circlePoint: function (point:Vec2) {
     ...
     * @ignore
     */
    circlePointDeterministic: function (point:Vec2, index:number, numPoints:number) {
    ...
    spherePointDeterministic (point:Vec3, index:number, numPoints:number, start = 0, end = 1):void {
        ...
        const y = MathTool.lerp(start, end, index / numPoints);
