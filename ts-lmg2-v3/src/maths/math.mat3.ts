...
class Mat3 {
     ...
     */
    transformVector(vec: Vec3, res: Vec3 = new Vec3()): Vec3 {
        const m = this.data;
     ...
     * @readonly
     */
    static IDENTITY: Mat3 = Object.freeze(new Mat3());
     ...
     * @readonly
     */
    static ZERO: Mat3 = Object.freeze(new Mat3().set([0, 0, 0, 0, 0, 0, 0, 0, 0]));
}
