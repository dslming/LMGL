...
class Http {
     ...
     * @returns {XMLHttpRequest} The request object.
     */
    post(url: any, data: any, options: { postdata?: any; }, callback: any) {
        if (typeof options === "function") {
            callback = options;
            options = {};
        }
     ...
     * @returns {XMLHttpRequest} The request object.
     */
    put(url: any, data: any, options: { postdata?: any; }, callback: any) {
        if (typeof options === "function") {
            callback = options;
            options = {};
        }
     ...
     * @returns {XMLHttpRequest} The request object.
     */
    del(url: any, options: {}, callback: any) {
        if (typeof options === "function") {
            callback = options;
            options = {};
        }
     ...
     * @returns {XMLHttpRequest} The request object.
     */
    request(method: string, url: string | URL, options: { retry?: any; callback?: any; async?: any; headers?: any; postdata?: any; cache?: any; query?: any; withCredentials?: any; responseType?: any; error?: any; }, callback: any) {
        ...
        xhr.onerror = () => {
            this._onError(method, url, options as any, xhr);
            errored = true;
        };
    ...
    _isBinaryContentType(contentType: string) {
        const binTypes = [
    ...
    _onReadyStateChange(method: any, url: any, options: any, xhr: XMLHttpRequest) {
        if (xhr.readyState === 4) {
            switch (xhr.status) {
                case 0: {
    ...
    _onSuccess(method: any, url: string, options: { callback: (arg0?: null, arg1?: undefined) => void; }, xhr: { getResponseHeader: (arg0: string) => any; responseText: string; response: any; responseType: string; responseXML: any; }) {
        let response;
        let contentType;
    ...
    _onError(method: any, url: any, options: { retrying: boolean; retry: any; retries: number; maxRetries: number; maxRetryDelay: any; callback: (arg0: any, arg1: null) => void; }, xhr: XMLHttpRequest) {
        if (options.retrying) {
            return;
        }
        ...
        if (options.retry && options.retries < options.maxRetries) {
            ...
            const retryDelay = MathTool.clamp(Math.pow(2, options.retries) * Http.retryDelay, 0, options.maxRetryDelay || 5000);
