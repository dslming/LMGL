...
const path = {
     ...
     */
    normalize: function (pathname: any) {
     ...
     */
    getBasename: function (pathname: any) {
     ...
     */
    getDirectory: function (pathname: any) {
        const parts = pathname.split(path.delimiter);
     ...
     */
    getExtension: function (pathname: any) {
     ...
     */
    isRelativePath: function (pathname: any) {
     ...
     * pc.path.extractPath("/path/to/file.txt");   // returns "/path/to"
     */
    extractPath: function (pathname: any) {
        let result = "";
        const parts = pathname.split("/");
        let i = 0;
